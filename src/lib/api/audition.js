 ...
 */
export function generateAudition({ bankEntryId, count = 3, views = ['front_portrait', 'profile_portrait'] }) {
  return apiPost('/api/audition/generate', { bankEntryId, count, views })
}
